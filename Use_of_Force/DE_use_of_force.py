...
def main() -> None:
    ...
    c19 = import_csv('vermont_population_2019.csv')
    
    # [VISUALIZATION] USE OF FORCE RACE STATS 
    race_dis = pd.DataFrame(df.race.value_counts())
    ...
    plt.title('Number of Use of Force Reports (from 2012-2018) by Race', fontsize=15, y=1.03)
    plt.xticks(rotation=30, fontsize=13)
    plt.yticks(fontsize=13)
    plt.text(-1, -450, 'Source: Burlington Police Open Data Sets', fontsize=12)
    ...
    plt.title('Vermont 2019 Population Percentages by Race', fontsize=15, y=1.03)
    plt.xticks(rotation=90, fontsize=13)
    plt.yticks(fontsize=13)
    plt.ylim(0, 105)
    plt.text(-1, -115, 'Source: United States Census Bureau', fontsize=12)
